...
# About:      ELGA FHIR® Core Profile for Organization.
# Created by: ELGA GmbH, Austria
##############################################################################*/

Profile:        AtElgaCoreOrganization
Parent:         HL7ATCoreOrganization
Id:             at-elga-core-organization
Title:          "AT ELGA Core Organization Profil"
Description:    "AT ELGA Core Organization Profil"
