...
# About:      ELGA FHIR® Core Profile for Practitioner.
# Created by: ELGA GmbH, Austria
##############################################################################*/

Profile:    AtElgaCorePractitioner
Parent:     HL7ATCorePractitioner
Id:         at-elga-core-practitioner
Title:      "AT ELGA Core Practitioner Profil"
Description: "AT ELGA Core Practitioner Profil"
