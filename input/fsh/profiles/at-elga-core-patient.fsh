...
# About:      ELGA FHIR® Core Profile for Patient.
# Created by: ELGA GmbH, Austria
##############################################################################*/

Profile:    AtElgaCorePatient
Parent:     HL7ATCorePatient
Id:         at-elga-core-patient
Title:      "AT ELGA Core Patient Profil"
Description: "AT ELGA Core Patient Profil"
